...
import com.zyh.wanandroid.utils.StatusBarUtil;
...
public class BaseToolbar extends RelativeLayout implements View.OnClickListener {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            fillStatusBar = array.getBoolean(R.styleable.BaseToolbar_fillStatusBar, DefaultValues.FILL_STATUS_BAR);
        }
        titleBarColor = array.getColor(R.styleable.BaseToolbar_toolbarBackgroundColor, Color.parseColor(DefaultValues.DEFAULT_THEME_COLOR));
        titleBarHeight = (int) array.getDimension(R.styleable.BaseToolbar_toolbarHeight, DimenUtil.dp2px(context, DefaultValues.HEADER_HEIGHT));
        statusBarColor = array.getColor(R.styleable.BaseToolbar_statusBarColor, Color.parseColor(DefaultValues.DEFAULT_THEME_COLOR));
        statusBarMode = array.getInt(R.styleable.BaseToolbar_statusBarMode, DefaultValues.DARK);

        showBottomLine = array.getBoolean(R.styleable.BaseToolbar_showBottomLine, DefaultValues.SHOW_BOTTOM_LINE);
        bottomLineColor = array.getColor(R.styleable.BaseToolbar_bottomLineColor, Color.parseColor(DefaultValues.DEFAULT_DIVIDER_COLOR));
        bottomShadowHeight = array.getDimension(R.styleable.BaseToolbar_bottomShadowHeight, DefaultValues.DEFAULT_NONE_RES);

        float defaultPadding = (int) array.getDimension(R.styleable.BaseToolbar_defaultPadding, DimenUtil.dp2px(context, DefaultValues.DEFAULT_PADDING));

        leftPaddingLeft = array.getDimension(R.styleable.BaseToolbar_leftPaddingLeft, defaultPadding);
        leftPaddingRight = array.getDimension(R.styleable.BaseToolbar_leftPaddingRight, defaultPadding);
        rightPaddingLeft = array.getDimension(R.styleable.BaseToolbar_rightPaddingLeft, defaultPadding);
        rightPaddingRight = array.getDimension(R.styleable.BaseToolbar_rightPaddingRight, defaultPadding);
        centerPaddingLeft = array.getDimension(R.styleable.BaseToolbar_centerPaddingLeft, defaultPadding);
        centerPaddingRight = array.getDimension(R.styleable.BaseToolbar_centerPaddingRight, defaultPadding);

        leftType = array.getInt(R.styleable.BaseToolbar_leftType, DefaultValues.TYPE_IMAGE_VIEW);
        if (leftType == DefaultValues.TYPE_TEXT_VIEW) {
            leftText = array.getString(R.styleable.BaseToolbar_leftText);
            leftTextColor = array.getColor(R.styleable.BaseToolbar_leftTextColor, Color.parseColor(DefaultValues.DEFAULT_TEXT_COLOR));
            leftTextSize = array.getDimension(R.styleable.BaseToolbar_leftTextSize, DimenUtil.sp2px(context, DefaultValues.DEFAULT_TEXT_SIZE));
        ...
        leftBackground = array.getResourceId(R.styleable.BaseToolbar_leftBackground, DefaultValues.DEFAULT_NONE_RES);

        rightType = array.getInt(R.styleable.BaseToolbar_rightType, DefaultValues.TYPE_NONE);
        if (rightType == DefaultValues.TYPE_TEXT_VIEW) {
            rightText = array.getString(R.styleable.BaseToolbar_rightText);
            rightTextColor = array.getColor(R.styleable.BaseToolbar_rightTextColor, Color.parseColor(DefaultValues.DEFAULT_TEXT_COLOR));
            rightTextSize = array.getDimension(R.styleable.BaseToolbar_rightTextSize, DimenUtil.sp2px(context, DefaultValues.DEFAULT_TEXT_SIZE));
        } else if (rightType == DefaultValues.TYPE_IMAGE_VIEW) {
            rightImageResource = array.getResourceId(R.styleable.BaseToolbar_rightImageResource, DefaultValues.DEFAULT_NONE_RES);
        } else if (rightType == DefaultValues.TYPE_CUSTOM_VIEW) {
            rightCustomViewRes = array.getResourceId(R.styleable.BaseToolbar_rightCustomView, DefaultValues.DEFAULT_NONE_RES);
        }
        rightBackground = array.getResourceId(R.styleable.BaseToolbar_rightBackground, DefaultValues.DEFAULT_NONE_RES);

        centerType = array.getInt(R.styleable.BaseToolbar_centerType, DefaultValues.TYPE_TEXT_VIEW);
        if (centerType == DefaultValues.TYPE_TEXT_VIEW) {
            centerText = array.getString(R.styleable.BaseToolbar_centerText);
            centerTextColor = array.getColor(R.styleable.BaseToolbar_centerTextColor, Color.parseColor(DefaultValues.DEFAULT_TEXT_COLOR));
            centerTextSize = array.getDimension(R.styleable.BaseToolbar_centerTextSize, DimenUtil.sp2px(context, DefaultValues.DEFAULT_TITLE_TEXT_SIZE));
            centerTextMarquee = array.getBoolean(R.styleable.BaseToolbar_centerTextMarquee, DefaultValues.TITLE_MARQUEE);
            centerSubText = array.getString(R.styleable.BaseToolbar_centerSubText);
            centerSubTextColor = array.getColor(R.styleable.BaseToolbar_centerSubTextColor, Color.parseColor(DefaultValues.DEFAULT_SUB_TEXT_COLOR));
            centerSubTextSize = array.getDimension(R.styleable.BaseToolbar_centerSubTextSize, DimenUtil.sp2px(context, DefaultValues.DEFAULT_SUB_TITLE_TEXT_SIZE));
        } else if (centerType == DefaultValues.TYPE_CUSTOM_VIEW) {
            centerCustomViewRes = array.getResourceId(R.styleable.BaseToolbar_centerCustomView, DefaultValues.DEFAULT_NONE_RES);
        }
    ...
    private void initStruct(Context context) {
        ViewGroup.LayoutParams globalParams = new ViewGroup.LayoutParams(DefaultValues.MATCH_PARENT, DefaultValues.WRAP_CONTENT);
        ...
        if (fillStatusBar && transparentStatusBar) {
            ...
            LayoutParams statusBarParams = new LayoutParams(DefaultValues.MATCH_PARENT, statusBarHeight);
        ...
        LayoutParams mainParams = new LayoutParams(DefaultValues.MATCH_PARENT, titleBarHeight);
        if (fillStatusBar && transparentStatusBar) {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(DefaultValues.MATCH_PARENT, Math.max(1, DimenUtil.dp2px(context, DefaultValues.DIVIDER_HEIGHT)));
            ...
            LayoutParams bottomShadowParams = new LayoutParams(DefaultValues.MATCH_PARENT, DimenUtil.dp2px(context, bottomShadowHeight));
    ...
    private void initTitle(Context context) {
        if (leftType != DefaultValues.TYPE_NONE) {
            initMainLeftViews(context);
        }
        if (rightType != DefaultValues.TYPE_NONE) {
            initMainRightViews(context);
        }
        if (centerType != DefaultValues.TYPE_NONE) {
            initMainCenterViews(context);
        }
    }

    private void initMainLeftViews(Context context) {
        LayoutParams leftInnerParams = new LayoutParams(DefaultValues.WRAP_CONTENT, DefaultValues.MATCH_PARENT);
    ...
    private void initMainRightViews(Context context) {
        LayoutParams rightInnerParams = new LayoutParams(DefaultValues.WRAP_CONTENT, DefaultValues.MATCH_PARENT);
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == DefaultValues.TYPE_TEXT_VIEW) {
            ...
            LayoutParams centerParams = new LayoutParams(DefaultValues.WRAP_CONTENT, DefaultValues.MATCH_PARENT);
            ...
            LinearLayout.LayoutParams centerTextParams = new LinearLayout.LayoutParams(DefaultValues.WRAP_CONTENT, DefaultValues.WRAP_CONTENT);
            ...
            LinearLayout.LayoutParams centerSubTextParams = new LinearLayout.LayoutParams(DefaultValues.WRAP_CONTENT, DefaultValues.WRAP_CONTENT);
            ...
            LayoutParams centerCustomParams = new LayoutParams(DimenUtil.getScreenWidth(context) * 7 / 10, DefaultValues.MATCH_PARENT);
    ...
    public void setCenterView(View centerView) {
        ...
        customCenter.setOnClickListener(this);
        LayoutParams centerInnerParams = new LayoutParams(DefaultValues.WRAP_CONTENT, DefaultValues.MATCH_PARENT);
